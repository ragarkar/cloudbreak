...
class EventAuthorizationUtilsTest {
    ...
    @Mock
    private AlternativeAuthorizationResourceActionProvider mockActionAlternativeProvider;
    ...
    void setUp() {
        ...
        underTest = new EventAuthorizationUtils(mockCommonPermissionCheckingUtils, mockActionAlternativeProvider);
    }

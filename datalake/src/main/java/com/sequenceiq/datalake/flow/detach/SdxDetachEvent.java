...
public enum SdxDetachEvent implements FlowEvent {
    ...
    SDX_DETACH_STACK_FAILED_EVENT(SdxDetachFailedEvent.class),
    SDX_DETACH_EXTERNAL_DB_SUCCESS_EVENT(),
    SDX_DETACH_EXTERNAL_DB_FAILED_EVENT(SdxDetachFailedEvent.class),
    SDX_ATTACH_NEW_CLUSTER_SUCCESS_EVENT(),
    SDX_ATTACH_NEW_CLUSTER_FAILED_EVENT(SdxDetachFailedEvent.class),
